  ...
  useEffect(() => {
    async function loadData() {
      try {
        ...
        const [projectsText, consultantsText] = await Promise.all([projectsResponse.text(), consultantsResponse.text()]);
  ...
  return React.createElement("div", { style: page },
    React.createElement("div", { style: container },
      ...
      (loading || feedWarning) ? React.createElement("div", { style: { ...card, background: loading ? "#eff6ff" : "#fff7ed", borderColor: loading ? "#bfdbfe" : "#fdba74" } },
        ...
        React.createElement("div", { style: { marginTop: 6, color: "#475569" } }, loading ? "The dashboard is pulling both projects and consultants from Google Sheets." : feedWarning)
      ) : null,
      ...
      tab === "financial" ? React.createElement(React.Fragment, null,
        React.createElement("div", { style: { display: "grid", gridTemplateColumns: "repeat(5, minmax(0, 1fr))", gap: 16 } },
          ...
          React.createElement(MetricCard, { label: "Current AP", value: shortCurrency(currentAP), note: "Obligations due" }),
          React.createElement(MetricCard, { label: "Net Cash View", value: shortCurrency(cashTotal + currentAR - currentAP), note: "Cash + AR - AP" }),
          React.createElement(MetricCard, { label: "Consultant Exposure", value: shortCurrency(totalConsultantExposure), note: "Across all live projects" })
        ),
